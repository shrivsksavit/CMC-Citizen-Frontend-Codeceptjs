...
Feature('CMC Citizen frontend on Local');

let envs = [
    {	Environment : 'LOCAL' , Url :'https://localhost:8000/login?response_type=code&state=d7d8c7b2-b789-4335-8230-a50a091ce0e3&client_id=cmc_citizen&redirect_uri=https://localhost:3000/receiver',User	:		'sumithmcts@gmail.com'		,	Password	:		'Password12'		}
]

let referenceNo = [
    {	ref	:		'000MC031'		,	pin	:		'MdVkCH85'		},
    {	ref	:		'000MC032'		,	pin	:		'UFHH3rfK'		}
]

let currentEnv = envs[0];

for(let i=0;i<1;i++) {
    Scenario('ClaimantL Create Claim', (I) => {
...
referenceNo.forEach(function(eachRef){
    Scenario('DefendantL View and respond to this claim', (I) => {
